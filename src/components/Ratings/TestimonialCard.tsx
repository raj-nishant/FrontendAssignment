const TestimonialCard: React.FC<{
  ...
  return (
    <div className="flex flex-col flex-1 p-9 bg-white rounded-3xl border-solid shadow-sm border-[0.722px] border-[color:var(--Neutral-Colors-Color-300,#F0F0F6)] max-md:px-5">
      ...
      <div className="mt-2 text-lg leading-8 text-gray-500">
        &quot;{description}&quot;
      </div>
      <div className="shrink-0 mt-9 h-px bg-zinc-200" />
